...
public class mfskVaricode {
	...
	static String varienc(int c) {
		if (c >= 0 && c < 256)
			return varicode[c];
		return varicode[0];
	}
	
	static int varidec(int symbol)
	{
		int i;
